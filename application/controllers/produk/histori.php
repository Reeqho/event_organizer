...
class histori extends CI_Controller
{
	...
	public function pesanMenungguKonfirmasi()
	{
		...
		$data['title'] = 'Pesanan Menunggu Konfirmasi';
		$data['pesanan'] = $this->Model_pesan->getPesanMenungguKonfirmasi();

		// Load view
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('pesan/pesanan_menunggu_konfirmasi', $data);
		$this->load->view('templates/footer');
	}
}
